...
export default function RegisterForm() {
  ...
  const { field: termsField } = useController({ name: "terms", control });
  ...
  const onSubmit = async (data) => {
    try {
      ...
      // ✅ Save user id so OnboardingPage can post profile to correct user
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader>
          <CardTitle className="text-center text-xl">Create your AlignMate account</CardTitle>
        </CardHeader>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input {...register("password")} type={showPassword ? "text" : "password"} className="pr-10" />
            ...
            <div className="space-y-2">
              <div className="flex items-start space-x-2">
                <Checkbox checked={!!termsField.value} onCheckedChange={termsField.onChange} />
